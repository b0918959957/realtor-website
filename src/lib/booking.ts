...
export const INTENTS = [
  ...
  { key: "furniture", label: "家具租賃", hint: "新居佈置、家具方案" },
  { key: "video", label: "影音拍攝", hint: "短影音、長影音行銷" },
  { key: "tax", label: "稅務諮詢", hint: "房地合一稅、契稅" },
  { key: "renovation", label: "簡易裝潢", hint: "輕裝修規劃與預算" },
...
export const MEET_TYPES = [
  { key: "office", label: "當面洽談", description: "高雄市・屏東市 約定地點" },
  { key: "phone", label: "電話聯繫", description: "由我主動致電給您" },
